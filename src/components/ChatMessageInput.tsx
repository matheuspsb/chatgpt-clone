...
export const ChatMessageInput = ({ disabled, onSend }: Props) => {
  ...
  return (
    ...
    >
      <textarea
        ref={textEl}
        className="flex-1 border-0 bg-transparent resize-none outline-none h-7 max-h-48 overflow-y-auto text-white"
      ...
      <div onClick={handleSendMessage} className={`text-white self-end p-1 cursor-pointer rounded
