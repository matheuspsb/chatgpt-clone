import { IconSunTwentyFour } from "./icons"


export const ChatPlaceholder = () => {
  return (
    <div className="m-5">
      <h3 className="text-4xl font-bold text-center my-8 text-white">CHATGPT</h3>
      ...
      <div className="flex flex-col md:flex-row gap-5 m-auto mb-8 md:max-w-4xl">
        ...
        <div>
          ...
          mb-3 p-3">"Explique o sentido da vida em termos simpples"</div>
          <div className="bg-white/5 rounded text-center text-sm text-white
          mb-3 p-3">"Explique o sentido da vida em termos simpples"</div>
          <div className="bg-white/5 rounded text-center text-sm text-white
          mb-3 p-3">"Explique o sentido da vida em termos simpples"</div>
